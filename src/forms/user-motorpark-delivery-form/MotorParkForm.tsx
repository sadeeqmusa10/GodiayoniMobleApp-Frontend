...
export default function MotorParkForm({ onSave, isLoading }: Props) {
  ...
  return (
    <ScrollView className="flex-1 bg-gray-100 p-5">
      {/* ---------- SENDER ---------- */}
      <Text className="text-lg font-bold mb-2">Sender</Text>
      ...
      {/* ---------- RECEIVER ---------- */}
      <Text className="text-lg font-bold mt-6 mb-2">Receiver</Text>
